...
export default async function StorePage({ params }: PageProps) {
  ...
  const categories = await getCategoriesForStore(store.id, 12);
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 pb-32 pt-10 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="p-4 shadow-[0_8px_20px_rgba(17,24,39,0.06)]">
        ...
        <Card className="p-6">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Badge variant="neutral" className="bg-[#fbf8f3] text-[#9aa3b2]">
              Scroll to explore
            </Badge>
          </div>
              ...
              {featuredProducts.map((product) => {
                ...
                return (
                  <Card
                    key={product.id}
                    variant="soft"
                    className="min-w-[220px] snap-start p-4 shadow-[0_12px_24px_rgba(17,24,39,0.08)]"
                  >
                    ...
                    <div className="mt-3">
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        ...
                        <Badge variant="neutral" className="border border-[#f4c44f] bg-transparent text-[10px] text-[#b57512]">
                          Featured
                        </Badge>
                      </div>
                    </div>
